...
$fetch_page = $conn->prepare("SELECT pid, product_name, product_tag, product_availability, product_price, product_img_1 FROM _jb_hair_post $product_cat ORDER BY pid DESC LIMIT $limit, $perpage");
$fetch_page->execute();
